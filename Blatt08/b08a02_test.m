...
%% Check trained networks
assert(isequal(regressionNormal, sol.regressionNormal), 'The non-regularized network object seems to be incorrectly configured');
assert(isequal(regressionReg, sol.regressionReg), 'The regularized network object seems to be incorrectly configured');

%% Check predictions
vecEqual(inputX, sol.inputX);
vecEqual(predictionsNormal, sol.predictionsNormal);
vecEqual(predictionsReg, sol.predictionsReg);
