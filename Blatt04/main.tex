        ...
        \item
            ...
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    ...
                    \draw[thick, color=green] (-3,1) -- (3, -2) node[anchor=south west]{Separierungslinie};
                \end{tikzpicture}
            \end{figure}
        \item
            \begin{eqnarray*}
        ...
        \item $ $
            \begin{figure}[H]
                ...
                \begin{tikzpicture}
                    ...
                    \draw (2,2) node[anchor=south west] {$x$};
                    \draw[thick, color=green] (-3,1) -- (3, -2) node[anchor=south west]{Separierungslinie};
                    \fill[opacity=0.5, color=blue] (-3,1) -- (3,-2) -- (3,3) -- (-3,3) -- cycle;
                    \fill[opacity=0.5, color=red] (-3,1) -- (3,-2) -- (3,-3) -- (-3,-3) -- cycle;
                \end{tikzpicture}
            \end{figure}
